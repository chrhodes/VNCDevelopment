...
using DemoAndTestLogging.Presentation.Views;
...
namespace DemoAndTestLogging
{
    ...
    {
        public const string APPLICATION_NAME = "DemoAndTestLogging";
        public new const string LOG_CATEGORY = "DemoAndTestLogging";
