...
namespace VNCSignalRServerHub
{
    public static class Common
    {
        ...
        public const string PROJECT_NAME = "VNCSignalRServerHub";
        public const string LOG_CATEGORY = "VNCSignalRServerHub";

#if NET48
        public const string cCONFIG_FILE = @"C:\temp\VNCSignalRServerHubNF_Config.xml";
#else
        public const string cCONFIG_FILE = @"C:\temp\VNCSignalRServerHub_Config.xml";
#endif
