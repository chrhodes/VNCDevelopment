...
namespace VNC.Prism.UILaunchApproaches.DomainServices
{
    public class UILaunchApproachesServicesModule : IModule
    {
        private readonly IRegionManager _regionManager;

    public UILaunchApproachesServicesModule(IRegionManager regionManager)
        {
            Int64 startTicks = 0;
