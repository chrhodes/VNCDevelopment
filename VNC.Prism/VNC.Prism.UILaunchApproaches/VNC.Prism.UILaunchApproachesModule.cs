...
using VNC.Prism.UILaunchApproaches.DomainServices;
using VNC.Prism.UILaunchApproaches.Presentation.ViewModels;
using VNC.Prism.UILaunchApproaches.Presentation.Views;
using VNC.WPF.Presentation.ViewModels;
using VNC.WPF.Presentation.Views;

namespace VNC.Prism.UILaunchApproaches
{
    public class UILaunchApproachesModule : IModule
    {
        private readonly IRegionManager _regionManager;

    // 01

    public UILaunchApproachesModule(IRegionManager regionManager)
        {
            Int64 startTicks = 0;
