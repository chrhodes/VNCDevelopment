...
{
    public partial class wucTFSQuery_Picker : UserControl
    {
        #region Constructors and Load

        public wucTFSQuery_Picker()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty NameDPProperty = DependencyProperty.Register(
            "NameDP", typeof(string), typeof(wucTFSQuery_Picker), 
            new PropertyMetadata(null, new PropertyChangedCallback(OnNameDPChanged)));
        ...
        public static readonly DependencyProperty QueryDPProperty = DependencyProperty.Register(
            "QueryDP", typeof(string), typeof(wucTFSQuery_Picker), 
            new PropertyMetadata(null, new PropertyChangedCallback(OnQueryDPChanged)));
        ...
        {
            wucTFSQuery_Picker picker = o as wucTFSQuery_Picker;
            if (picker != null)
