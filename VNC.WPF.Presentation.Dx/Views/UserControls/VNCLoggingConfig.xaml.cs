...
namespace VNC.WPF.Presentation.Dx.Views
{
    public partial class VNCLoggingConfig : UserControl, INotifyPropertyChanged
    {
        ...
        {
            Common.VNCLogging.DeviceInitalize = (Boolean)e.NewValue;
        }
        ...
        {
            Common.VNCLogging.Arch107 = (Boolean)e.NewValue;
        }
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            ceArch07C.IsChecked = Common.VNCLogging.DeviceInitalize;
            ...
            //ceArch107C.IsChecked = Common.VNCLogging.Arch107;
